    ...
    public partial class frm_compra : Form
    {
        ...
        private void frm_compra_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cn.Open();
                cmd = new MySqlCommand("select nombre_c, nombre_i, nombre_g, direccion, contrato, objeto, monto from pr_compra where hidden=0", cn);
        ...
        private void btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            string cadsql = "select * from pr_compra where cedula_c='" + mtb_buscador.Text + "'";
        ...
        private void mtb_cedula_c_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == Convert.ToChar(Keys.Enter))
            {
                ...
                string cadsql = "select * from pr_clientes where cedula='" + mtb_cedula_c.Text + "'";
                MySqlCommand com = new MySqlCommand(cadsql, con);
                con.Open();
                MySqlDataReader leer = com.ExecuteReader();
                if (leer.Read() == true)
        ...
        {
            rango_compra compra = new rango_compra();
            compra.Show();
        }
        ...
        {
            frm_clientes terceros = new frm_clientes();
            terceros.Show();
        }
